          ...
          children: [
            ...
            Padding(
              ...
              child: Center(
                child: Expanded(
                  child: Text(
                    ' The Taj Mahal, is an Islamic ivory-white marble mausoleum on the right bank of the river Yamuna in the In'
                        'dian city of Agra. It was commissioned in 1631 by the Mughal emperor Shah Jahan'
                        ' to house the tomb of his favourite wife, Mumtaz Mahal; it also houses the tomb'
                        ' of Shah Jahan himself.',
                    style: GoogleFonts.lato(
                        color: Colors.grey[700],
                        letterSpacing: 0,
                        fontSize: 14,
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: (){
                            Uri url = Uri.parse('https://en.wikipedia.org/wiki/Taj_Mahal');
                            launchUrl(url);
                          },
                          child: Padding(
